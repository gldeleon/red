  ...
  $.widget('ui.weekCalendar', (function() {
    ...
    return {
      ...
      /*
        ...
        * it will be added.
        */
      updateEvent: function(calEvent, color) {
          this._updateEventInCalendar(calEvent, color);
      },
      ...
      _renderCalendarButtons: function($calendarContainer) {
        ...
        if (options.buttons) {
            ...
            calendarNavHtml += '<div class=\"ui-widget-header wc-toolbar\">';
              ...
              //calendarNavHtml += '<span class=\"cliSel\">dentalia ' + clinica + '</span>';
            calendarNavHtml += '</div>';
...
//              calendarHeaderHtml+=    "</div>";
  ...
  TODO    if total height for an hour is less than 11px, there is a display problem.
      ...
      _renderEvent: function(calEvent, $weekDay) {
          ...
          eventHtml = '<div class=\"' + eventClass + ' ui-corner-all\" style="background-color:'+calEvent.color+'">';
          eventHtml += '<div class=\"wc-time ui-corner-top\" style="background-color:'+calEvent.headerColor+'; border:none;" ></div>';
      ...
      /*
        ...
        */
      _updateEventInCalendar: function(calEvent, color) {
          var self = this;
      ...
      _addDraggableToCalEvent: function(calEvent, $calEvent) {
          ...
          $calEvent.draggable({
            ...
            grid: [$calEvent.outerWidth(), options.timeslotHeight],
            	//[$calEvent.outerWidth() + 1, options.timeslotHeight],
      ...
      _addDroppableToWeekDay: function($weekDay) {
          ...
          $weekDay.droppable({
            ...
            drop: function(event, ui) {
                ...
                options.eventDrop(newCalEvent, calEvent, freeBusyManager, $calEvent);
      ...
      _addResizableToCalEvent: function(calEvent, $calEvent, $weekDay) {
          ...
          $calEvent.resizable({
            ...
            newEnd = self._getDSTdayShift(newEnd, -1);
                ...
                options.eventResize(newCalEvent, calEvent, $calEvent, freeBusyManager);
                $calEvent.data('preventClick', true);
                setTimeout(function() {
      ...
      _getHeaderDate: function(date) {
        ...
        return dayName + (options.headerSeparator); //+ "Sillones";
